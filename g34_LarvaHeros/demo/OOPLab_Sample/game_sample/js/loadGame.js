...
(function(){
    ...
    [
        ...
        { src: 'game_sample/js/end.js', lookFor: 'end' },
        { src: 'game_sample/js/character.js', lookFor: 'Character' },
	    { src: 'game_sample/js/Camp.js', lookFor: 'Camp' },
	    { src: 'game_sample/js/Enemy.js', lookFor: 'Enemy' },
        { src: 'game_sample/js/Falling.js', lookFor: 'Falling' },
        { src: 'game_sample/js/Army.js', lookFor: 'Army' },
	    { src: 'game_sample/js/Practice.js', lookFor: 'Practice' },
        { src: 'game_sample/js/Victory.js', lookFor: 'Victory' },
